...
public class Students  {
	...
	public void showAllStudent() {
		System.out.println("Student Name \t Reg Number  \t Address");
		for(int i=0;i<count;i++) {
			System.out.println(theStudents[i].studentName+"\t"+theStudents[i].regNum+" \t"+theStudents[i].contact+"  \t"+theStudents[i].address);
